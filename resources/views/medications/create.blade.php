<x-layout>
    <div class="container">
        <h2 class="mb-4">Add New Medication</h2>
        ...
        <form method="POST" action="{{ route('medications.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <label>Name</label>
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="e.g. Amoxicillin">
                    @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="col-md-4">
                    <label>Generic Name (Optional)</label>
                    <input type="text" name="generic_name" value="{{ old('generic_name') }}" class="form-control" placeholder="e.g. Amoxicillin">
                </div>
                <div class="col-md-4">
                    <label>Barcode / NDC (Optional)</label>
                    <input type="text" name="barcode_or_ndc" value="{{ old('barcode_or_ndc') }}" class="form-control" placeholder="Unique code or NDC">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="strength" value="{{ old('strength') }}" class="form-control" placeholder="e.g. 500">
                ...
                <div class="col-md-4">
                    ...
                    <select name="unit_of_strength" class="form-select">
                        ...
                        @foreach($unitStrengths as $unit)
                            <option value="{{ $unit }}" {{ old('unit_of_strength') == $unit ? 'selected' : '' }}>{{ $unit }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="pack_size" value="{{ old('pack_size') }}" class="form-control" placeholder="e.g. 30">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <select name="dispensing_unit" class="form-select">
                        ...
                        @foreach($dispensingUnits as $unit)
                            <option value="{{ $unit }}" {{ old('dispensing_unit') == $unit ? 'selected' : '' }}>{{ $unit }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="manufacturer" value="{{ old('manufacturer') }}" class="form-control" placeholder="e.g. GlaxoSmithKline">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="storage_conditions" value="{{ old('storage_conditions') }}" class="form-control" placeholder="e.g. Store below 25°C">
            </div>

            <div class="mb-3">
                <label>Description (Optional)</label>
                <textarea name="description" class="form-control" rows="3" placeholder="Short description or notes...">{{ old('description') }}</textarea>
            </div>
